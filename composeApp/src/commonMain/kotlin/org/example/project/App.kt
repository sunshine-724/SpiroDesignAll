    ...
    private fun MainScreenContent(
        ...
        val scope = rememberCoroutineScope() // suspend関数を呼び出すためのスコープ
            ...
            CustomButton("Load") {
                scope.launch {
                    ...
                    if (fileContent != null) {
                        ...
                        loadedDataInfo = "${pathPoints.size} 件のデータをロードしました。"
                        // ここで読み込んだデータ(pathPoints)を使って、描画更新などの処理を行う
                    } else {
                        loadedDataInfo = "ファイルの選択がキャンセルされました。"
                    }
                }
            }
            CustomButton("Export") {}
